...
describe("package account selection test", () => {
    ...
    const disableableOptions: [string, EnvKey, string][] = [
        ...
        ["welsh", "DISABLE_WELSH_ACCOUNTS_RADIO", "welsh"]
    ];
...
describe("Welsh translation", () => {
    ...
    it("should translate page into Welsh", async () => {
        ...
        expect(resp.text).toContain(`Cyfrifon pecyn grŵp-Rhan 401, rhiant wedi eu corffori o dan gyfraith y tu allan i&#39;r DU`);
