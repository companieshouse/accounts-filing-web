...
describe("UploadHandler", () => {
    ...
    beforeEach(() => {
        ...
        session.setExtraData(ContextKeys.PACKAGE_TYPE, PackageTypeDetails.uksef.name);
    ...
    it("should return 200 with file upload url ", async () => {
        ...
        const expectedUrl =
        "http://chs.locl/xbrl_validate/submit?callback=http%3A%2F%2Fchs.local%2Faccounts-filing%2Fuploaded%2F%7BfileId%7D&backUrl=http%3A%2F%2Fchs.local%2Faccounts-filing%2Fchoose-your-accounts-package%3FcompanyNumber%3D123456&packageType=uksef";
